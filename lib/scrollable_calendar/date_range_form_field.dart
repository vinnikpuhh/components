...
class DateRangeFieldA extends FormField<DateTimeRange> {
      ...
      : super(
            ...
            builder: (FormFieldState<DateTimeRange> state) {
              ...
              final InputDecoration inputDecoration = decoration
                  ...
                  .applyDefaults(
                       InputDecorationTheme(focusColor: focusColor));

              /// This is the dialog to select the date range.
              Future<void> selectDateRangeFork() async {
                DateTimeRange? picked = await showDateRangePickerFork(
              ...
              return InkWell(
                ...
                onTap: enabled ? selectDateRangeFork : null,
                child: Container(
